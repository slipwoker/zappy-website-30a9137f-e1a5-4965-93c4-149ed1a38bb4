    ...
    contactForm.addEventListener('input', function(e) {
      if (e.target.matches('input, textarea, select')) {
        ...
        const errorElement = e.target.parentElement.querySelector('.error-message') || 
                           e.target.nextElementSibling?.classList.contains('error-message') ? 
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "דפוס סופר גולד משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
                ...
                body: JSON.stringify({
                    websiteId: '30a9137f-e1a5-4965-93c4-149ed1a38bb4',
                    name: data.name || '',
                    email: data.email || '',
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '30a9137f-e1a5-4965-93c4-149ed1a38bb4';
